...
export function ReservasiClient() {
  ...
  const layananList = [
    { id: "akupunktur", label: language === "id" ? "Akupunktur" : "Acupuncture", emoji: "🪡", color: "border-blush/30 hover:bg-blush-soft/60" },
    { id: "hidroterapi", label: language === "id" ? "Hidroterapi" : "Hydrotherapy", emoji: "🌊", color: "border-hydro/30 hover:bg-hydro-soft/60" },
    { id: "fisioterapi", label: language === "id" ? "Fisioterapi" : "Physiotherapy", emoji: "💪", color: "border-sage/30 hover:bg-sage-soft/60" },
    { id: "swim-course", label: "Swim Course", emoji: "🏊", color: "border-sand/40 hover:bg-sand-soft/60" },
  ];
